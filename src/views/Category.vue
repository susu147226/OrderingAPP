    ...
    <page-view class="flex flex-col">
        ...
        <div v-else class="flex-1 overflow-auto flex flex-row">
            ...
            <div class="flex-1 overflow-auto">
                <IndexBar :index-list="[indexList]" ref="rightIndexBar" :sticky="false" @change="indexBarChange">
                    <template v-for="(item, index) in allCategoryList" :key="item.id">
                        <IndexAnchor :index="index">
                            <div class="text-primaryColor text-[18px] font-bold py-3px]">{{ item.category_name }}
                            </div>
                        </IndexAnchor>
                        ...
                        <div v-for="f_item in item.foodInfoList" :key="f_item.id"
                            ...
                            <img v-lazy="baseURL + f_item.food_img" class="w-[110px] h-full" alt="" />
