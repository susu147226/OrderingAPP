            ...
            <div class="flex-1 overflow-auto pb-[var(--van-action-bar-height)]" ref="foodInfoContent">
                <List v-model:loading="isLoading" :finished="finished" finished-text="没有更多了"
                    ...
                    <ul
                        ...
                        <li>
                            <span class="font-bold">名称：</span>{{ foodDetail.food_name }}
                        </li>
                        <li>
                            <span class="font-bold">价格：</span>￥ {{ foodDetail.price }}
                        </li>
                        <li>
                            <span class="font-bold">分类：</span>{{ foodDetail.categoryInfo.category_name }}
                        </li>
                        <li class="indent-[2em]">
