<template>
    <page-view class="flex flex-col">
        ...
        <div class="flex-1 overflow-auto">
            <div class=" flex flex-col justify-center items-center h-[160px] bg-gradient-to-b from-blue-200 to-purple-300">
                <img v-if="loginUserInfo" v-lazy="baseURL + loginUserInfo.user_photo"
                    class="w-[80px] h-[80px] rounded-full" alt="">
